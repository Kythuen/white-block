      ...
      >
        ...
        >
          <div overflow="hidden" rounded="3">
            <img w="12" aspect-ratio="1" :src="withBase(item.img)" />
          </div>
          <div fw="400">{{ item.label }}</div>
        </div>
      </div>
...
const THEME_CATEGORY = [
  { label: 'Preset', value: 'preset', img: '/assets/img/theme/preset.svg' },
  { label: 'Color', value: 'color', img: '/assets/img/theme/color.svg' },
  { label: 'Size', value: 'size', img: '/assets/img/theme/size.svg' },
  { label: 'Font', value: 'font', img: '/assets/img/theme/font.svg' }
]
