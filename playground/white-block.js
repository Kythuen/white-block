...
import { getCurrentInstance, computed, ref, onMounted, onBeforeUnmount, h, defineComponent, mergeDefaults, createBlock, openBlock, resolveDynamicComponent, mergeProps, unref, withCtx, createElementBlock, createCommentVNode, createVNode, withModifiers, Fragment, renderList, toRefs, normalizeStyle, normalizeClass, createElementVNode, watch, nextTick, Teleport, withDirectives, Transition, renderSlot, vShow, isRef, toDisplayString, watchEffect, provide, inject, createTextVNode } from "vue";
...
function eventDelegate(e, className, handler, fallback) {
  var _a;
  const domList = e.path ?? (e.composedPath && e.composedPath());
  const target = ((_a = domList[0]) == null ? void 0 : _a.className) === className;
  if (target) {
    handler(e);
    return;
  }
...
function matchItems(pattern, list) {
  ...
  setup(__props) {
    ...
    const propsStyles = useStyles(() => {
      if (props.color) {
        ...
        return {
          "--wb-button-main-color": `rgb(${color2.join(" ")} / ${valpha})`,
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(
        ...
        [
          ...
          _ctx.icon || _ctx.loading || _ctx.clearable ? (openBlock(), createElementBlock("button", _hoisted_2$9, [
...
const _sfc_main$c = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    function handleHideSelect() {
      ...
      emits("select", (_a = props.options[currentIndex.value]) == null ? void 0 : _a.value);
      emits("hide");
    }
    return (_ctx, _cache) => {
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        _ctx.theme === "side" ? (openBlock(), createBlock(unref(Button), {
          key: 0,
          tabindex: "-1",
          "data-key": "sub",
          type: "outline",
